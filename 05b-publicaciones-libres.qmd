...
@swan_directrices_2013 -representante de UNESCO- define dos rutas principales (tipos de repositorios) donde depositar publicaciones con el rótulo del Open Access (Dorado y Verde), pero en la práctica se pueden diferenciar en cinco. Según @universoabierto_5_2019 las principales características de cada una son:
...
: Tabla comparativa del uso de SocArXiv versus otros sitios {#tbl-coom}
